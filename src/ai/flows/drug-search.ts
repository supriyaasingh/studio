...
const DrugSearchOutputSchema = z.object({
  ...
  dosePerKg: z.number().describe('The standard dose per kg of the drug.'),
...
2. Standard dose per kg (dosePerKg) - this is required.
3. Max daily dose per kg (maxDailyDosePerKg) - if applicable
4. Frequency (frequency) - if applicable
5. Drug type (category)
6. Form (form) - if applicable, e.g., syrup, tablet
7. Strength (strength) - if applicable, e.g., 125mg/5mL
